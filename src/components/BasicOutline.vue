    ...
    <div class="flex justify-between h-16">
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:ml-4 md:flex-shrink-0 md:flex md:items-center">
          ...
          <!-- Profile dropdown -->
          <div @click="toggleAccountOpen" id="account-dropdown" 
          class="ml-3 relative">
            <div>
            ...
            -->
            <div id="hal" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" 
            v-bind:class="{hidden: !accountOpen}"
